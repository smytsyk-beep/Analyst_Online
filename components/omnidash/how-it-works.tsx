        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {t.steps.map((step, i) => (
            <div key={step.number} className="relative">
              {/* Connector line */}
              {i < t.steps.length - 1 && (
                <div className="absolute left-full top-6 hidden h-px w-6 bg-border/70 lg:block" />
              )}

              <div className="glass-card rounded-lg p-6 transition-all duration-200 hover:border-primary">
