  ...
  return (
    <section className="py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="rounded-lg border-2 border-omni-blue bg-omni-blue/5 p-10 text-center shadow-md md:p-16">
          <h2 className="text-3xl font-bold text-omni-navy md:text-4xl">{t.ctaTitle}</h2>
          <p className="mx-auto mt-4 max-w-xl text-lg text-omni-navy/70">{t.ctaSubtitle}</p>
