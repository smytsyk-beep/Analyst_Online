  ...
  return (
    <section className="py-16 md:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <h2 className="text-3xl font-bold text-foreground md:text-4xl">{t.socialProofTitle}</h2>
        <p className="mt-2 text-foreground/70">{t.socialProofSubtitle}</p>
        ...
        <Card className="mt-8 rounded-lg border border-lime-accent/30 bg-lime-accent/5">
          <CardContent className="flex items-start gap-3 p-6">
            ...
            <p className="text-sm leading-relaxed text-foreground/80">{t.socialProofNote}</p>
          </CardContent>
        </Card>
      </div>
    </section>
