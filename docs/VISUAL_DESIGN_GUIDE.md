...
**Версия:** 1.1  
**Дата:** 2026-04-15  
**Основа:** Analyst-Online Brand Guide

---

## 1. Философия дизайна

Analyst Online следует визуальному языку **study AI** — чистый SaaS-стиль, доверие к данным, ясность, премиальная простота.
...
**Минимальные, быстрые, функциональные** — современные эффекты.
